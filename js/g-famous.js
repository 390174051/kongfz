...
$.ajax({
    type: "GET",
    url: "http://localhost/kongfz/g-connect3.php?page=1",
    dataType:"JSON",
...
$(".previous").on("singleTap",function(){
    ...
    $(".g-asc").on("singleTap",function(){
        $.ajax({
            type: "GET",
            url: "http://localhost/kongfz/kongfz/g-connect3.php?page=1",
            dataType:"JSON",
            success: function(data) {
                var list = JSON.parse(data)
...
$(".next").on("singleTap",function(){
    ...
    $(".g-asc").on("singleTap",function(){
        $.ajax({
            type: "GET",
            url: "http://localhost/kongfz/g-connect3.php?page=2",
            dataType:"JSON",
            success: function(data) {
                var list = JSON.parse(data)
                function ascprice(a,b){
...
$.ajax({
    type: "GET",
    url: "http://localhost/kongfz/g-connect3.php?page="+ data,
    dataType:"JSON",
    success: function(data) {
        var list = JSON.parse(data)
        $(".content").empty()
